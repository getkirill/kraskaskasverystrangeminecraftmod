...
public class RubyItem extends KraskaskasModModElements.ModElement {
	@ObjectHolder("kraskaskas_mod:ruby")
	public static final Item block = null;
	public RubyItem(KraskaskasModModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("It's glowing"));
		}
	}
}
