...
package com.kraskaska.mc.kraskaskasmod.block;
...
import com.kraskaska.mc.kraskaskasmod.item.RubyItem;
import com.kraskaska.mc.kraskaskasmod.KraskaskasModModElements;

@KraskaskasModModElements.ModElement.Tag
public class RubyOreBlock extends KraskaskasModModElements.ModElement {
	@ObjectHolder("kraskaskas_mod:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(KraskaskasModModElements instance) {
		super(instance, 16);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 16)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(10, 0, 0, 20))));
		}
	}
}
